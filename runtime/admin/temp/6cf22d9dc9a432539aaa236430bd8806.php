<?php /*a:5:{s:56:"D:\dev\www\LanHaiService\app\admin\view\node\update.html";i:1694898196;s:58:"D:\dev\www\LanHaiService\app\admin\view\layout\layout.html";i:1734774767;s:54:"D:\dev\www\LanHaiService\app\admin\view\node\icon.html";i:1694898196;s:56:"D:\dev\www\LanHaiService\app\admin\view\public\form.html";i:1694898196;s:54:"D:\dev\www\LanHaiService\app\admin\view\public\js.html";i:1734774942;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
  <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight ibox-content">
    <form class="form-horizontal m" id="hr-form" data-ref="node">
        <input type="hidden" value="<?php echo htmlentities((string) $model['id']); ?>" name="id">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input class="form-control" type="text" name="title" id="title" value="<?php echo htmlentities((string) $model['title']); ?>" required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">请求地址：</label>
            <div class="col-sm-8">
                <input id="url" name="url" class="form-control" type="text" value="<?php echo htmlentities((string) $model['url']); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input class="form-control" type="text" name="sort" value="<?php echo htmlentities((string) $model['sort']); ?>" required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">图标：</label>
            <div class="col-sm-8">
                <input id="icon" name="icon" class="form-control" type="text" value="<?php echo htmlentities((string) $model['icon']); ?>" placeholder="选择图标" autocomplete="off">
...
<script>
    ...
    $("#parent_id").ajaxSelect({
        ...
        field:"title",
        defaultText:"顶级节点",
        value:"<?php echo htmlentities((string) $model['parent_id']); ?>"
    });

    $("#status_<?php echo htmlentities((string) $model['status']); ?>").prop("checked","checked");
    $("#node-type").find("input[value=<?php echo htmlentities((string) $model['type']); ?>]").prop("checked","checked");
