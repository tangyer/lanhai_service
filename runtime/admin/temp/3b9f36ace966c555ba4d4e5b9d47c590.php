<?php /*a:3:{s:71:"D:\phpstudy_pro\WWW\LanHaiService\app\admin\view\active_code\index.html";i:1734705344;s:67:"D:\phpstudy_pro\WWW\LanHaiService\app\admin\view\layout\layout.html";i:1735125879;s:63:"D:\phpstudy_pro\WWW\LanHaiService\app\admin\view\public\js.html";i:1734774942;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
  <meta charset="utf-8">
        ...
        <div class="col-sm-12 search-collapse">
            <form id="role-form">
                <div class="select-list">
                    <ul>
                            <li>
     商户ID <input type="text"  name="merchant_id"  id="merchant_id">
    </li>
    <li>
     激活码 <input type="text"  name="active_code"  id="active_code">
    </li>
    <li>
     使用平台 <input type="text"  name="platform"  id="platform">
    </li>
