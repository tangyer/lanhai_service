...
<div class="wrapper wrapper-content animated fadeInRight ibox-content">
    <form class="form-horizontal m" id="hr-form" data-ref="config">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" id="title" class="form-control" placeholder="请输入配置标题" name="title"
                       value="<?php echo htmlentities((string) $model['title']); ?>" readonly required/>
            </div>
        </div>
<!--        <div class="form-group">-->
<!--            <label for="name" class="col-sm-3 control-label is-required">名称</label>-->
<!--            <div class="col-sm-8">-->
<!--                <input type="text" id="name" class="form-control" placeholder="请输入名称" name="name" value="<?php echo htmlentities((string) $model['name']); ?>"-->
<!--                       required/>-->
<!--            </div>-->
<!--        </div>-->
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" id="value" class="form-control" placeholder="请输入配置值" name="value"
                       value="<?php echo htmlentities((string) $model['value']); ?>" required/>
            </div>
        </div>
        <div class="form-group">
            <label for="sort" class="col-sm-3 control-label is-required">排序</label>
            <div class="col-sm-8">
                <input type="text" id="sort" class="form-control" placeholder="请输入排序" name="sort" value="<?php echo htmlentities((string) $model['sort']); ?>"
                       required/>
            </div>
        </div>
<!--        <div class="form-group">-->
...
<!--            <div class="col-sm-8">-->
<!--                <input type="text" id="group" class="form-control" placeholder="请输入分组" name="group"-->
<!--                       value="<?php echo htmlentities((string) $model['group']); ?>" required/>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="form-group">-->
<!--            <label for="description" class="col-sm-3 control-label is-required">配置说明</label>-->
<!--            <div class="col-sm-8">-->
<!--                <input type="text" id="description" class="form-control" placeholder="请输入配置说明" name="description"-->
<!--                       value="<?php echo htmlentities((string) $model['description']); ?>" required/>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="form-group">-->
<!--            <label for="status" class="col-sm-3 control-label is-required">状态</label>-->
<!--            <div class="col-sm-8">-->
<!--                <input type="text" id="status" class="form-control" placeholder="请输入状态" name="status"-->
<!--                       value="<?php echo htmlentities((string) $model['status']); ?>" required/>-->
<!--            </div>-->
<!--        </div>-->
