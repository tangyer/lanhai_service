...
<!--                <label class="radio-box"> <input type="radio" name="type" value="2" /> 目录 </label>-->
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input class="form-control" type="text" name="app_type" id="app_type" value="<?php echo htmlentities((string) $app_type); ?>" readonly required>
            </div>
        </div>
        <div class="form-group">
