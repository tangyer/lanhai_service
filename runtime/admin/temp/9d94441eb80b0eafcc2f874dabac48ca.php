...
<div class="wrapper wrapper-content animated fadeInRight ibox-content">
    <form class="form-horizontal m" id="hr-form" data-ref="translateEngine">
       ...
       <label  class="col-sm-3 control-label is-required" >引擎名称</label>
        <div class="col-sm-8">
           <input  type="text" id="engine_name" class="form-control " placeholder="请输入引擎名称" name="engine_name"  required />
        </div>
    </div>
    <div class="form-group">
       <label  class="col-sm-3 control-label is-required" >引擎编码</label>
        <div class="col-sm-8">
           <input  type="text" id="engine_code" class="form-control " placeholder="请输入引擎编码" name="engine_code"  required />
        </div>
    </div>
    <div class="form-group">
...
<div class="radio-box">
    <input type="radio" id="engine_type_<?php echo htmlentities((string) $dict['dict_value']); ?>" name="engine_type" value="<?php echo htmlentities((string) $dict['dict_value']); ?>" <?php echo $dict['is_default']==1 ? "checked"  :  ""; ?>>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="form-group">
       <label  class="col-sm-3 control-label is-required" >引擎排序</label>
        <div class="col-sm-8">
           <input  type="text" id="engine_sort" class="form-control " placeholder="请输入引擎排序" name="engine_sort"  required />
        </div>
    </div>
    <div class="form-group">
