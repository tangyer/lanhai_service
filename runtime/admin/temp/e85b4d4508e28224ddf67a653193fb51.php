<?php /*a:4:{s:64:"D:\phpstudy_pro\WWW\LanHaiService\app\admin\view\node\index.html";i:1734949590;s:67:"D:\phpstudy_pro\WWW\LanHaiService\app\admin\view\layout\layout.html";i:1735125879;s:66:"D:\phpstudy_pro\WWW\LanHaiService\app\admin\view\public\table.html";i:1734450252;s:63:"D:\phpstudy_pro\WWW\LanHaiService\app\admin\view\public\js.html";i:1734774942;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
  <meta charset="utf-8">
        ...
        <div class="col-sm-12 search-collapse">
            <form id="node-form">
                <div class="select-list">
                    <ul>
                        <li>
                            节点名称：<input type="text" name="title"/>
                        </li>
                        <li>
                            节点状态：
                            <select name="status" >
                        ...
                        <li>
                            ...
                            <select name="app_type" id="app_type">
                                ...
                                <option value="merchant">商户后台</option>
                            </select>
                        </li>
                        <li>
...
<!--            </a>-->
        ...
        <div class="col-sm-12 select-table table-striped">
            <table id="boot-tree-table"></table>
        </div>
    </div>
</div>
...
<script src="/static/ajax/tables/admin/node.js?v=1.0"></script>



<script>
    function add(){
        $.operate.add($('#app_type').val())
    }
</script>
