<?php /*a:3:{s:76:"D:\phpstudy_pro\WWW\LanHaiService\app\admin\view\translate_engine\index.html";i:1734946746;s:67:"D:\phpstudy_pro\WWW\LanHaiService\app\admin\view\layout\layout.html";i:1735125879;s:63:"D:\phpstudy_pro\WWW\LanHaiService\app\admin\view\public\js.html";i:1734774942;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
  <meta charset="utf-8">
            ...
            <form id="role-form">
                <div class="select-list">
                    <ul>
                        ...
                        <li>
                             引擎编码
                                  <input type="text"  name="engine_code"  id="engine_code">
                        </li>
                        <li>
                             引擎类型
                             <select class=" select2" id="engine_type"  name="engine_type"  >
...
var editFlag = "";
var removeFlag = "";
var prefix = ctx + "/translateEngine";
var sysTransType = JSON.parse('<?php echo get_dict("sys_trans_type",true); ?>') ;
...
$(function() {
    var options = {
        ...
        sortName: "engine_sort",
        modalName: "翻译引擎",
        uniqueId:"id",
        columns:[
            {checkbox:true},
            {field:"engine_name",title:"引擎名称" },
            {field:"engine_code",title:"引擎编码" },
            {field:"engine_type",title:"引擎类型" ,formatter:function (value){
                    return $.table.selectDictLabel(sysTransType,value)
                }},
            {field:"engine_sort",title:"引擎排序" },
