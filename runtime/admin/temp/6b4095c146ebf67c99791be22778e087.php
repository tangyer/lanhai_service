...
<div class="wrapper wrapper-content animated fadeInRight ibox-content">
    <form class="form-horizontal m" id="hr-form" data-ref="activeCodeGroup">
       ...
       <label  class="col-sm-3 control-label is-required" >所属商户</label>
        <div class="col-sm-8">
           <input  type="text" id="merchant_id" class="form-control " placeholder="请输入所属商户" name="merchant_id" value="<?php echo htmlentities((string) $model['merchant_id']); ?>" required />
        </div>
    </div>
    <div class="form-group">
       <label  class="col-sm-3 control-label is-required" >激活码</label>
        <div class="col-sm-8">
           <input  type="text" id="active_code" class="form-control " placeholder="请输入激活码" name="active_code" value="<?php echo htmlentities((string) $model['active_code']); ?>" required />
        </div>
    </div>
    <div class="form-group">
       <label  class="col-sm-3 control-label is-required" >分组名称</label>
        <div class="col-sm-8">
           <input  type="text" id="group_name" class="form-control " placeholder="请输入分组名称" name="group_name" value="<?php echo htmlentities((string) $model['group_name']); ?>" required />
        </div>
    </div>
    <div class="form-group">
...
<div class="radio-box">
    <input type="radio" id="status_<?php echo htmlentities((string) $dict['dict_value']); ?>" name="status" value="<?php echo htmlentities((string) $dict['dict_value']); ?>" <?php echo $dict['is_default']=="Y" ? "checked"  :  ""; ?>>
