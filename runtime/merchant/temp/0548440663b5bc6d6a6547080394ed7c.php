    ...
    <div class="panel panel-primary panel-intro" style="width: 75%;margin: 0 auto" >
        ...
        <div class="panel-body">
            <form class="form-horizontal">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 control-label" >分享链接</label>
                    <div class="col-sm-6">
                        <p class="form-control-plaintext"><?php echo htmlentities((string) $model['link']); ?></p>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 control-label" >到期时间</label>
                    <div class="col-sm-6">
                        <p class="form-control-plaintext"><?php echo htmlentities((string) get_time($model['expire_time'])); ?></p>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 control-label" >分享密码</label>
                    <div class="col-sm-6">
                        <p class="form-control-plaintext"><?php echo htmlentities((string) $model['password']); ?></p>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group" style="margin-top: 20px !important;">
                    <div class="col-sm-offset-5 col-sm-6">
                        <a type="button" class="btn btn-sm btn-primary" href="<?php echo url('workOrderShare/update',['id' => $model['id']]); ?>"><i class="fa fa-check"></i>编辑</a>&nbsp;
