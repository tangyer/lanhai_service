...
<div class="wrapper wrapper-content animated fadeInRight ">
    <form class="form-horizontal m" id="hr-form" data-ref="keyword">
       ...
       <label  class="col-sm-3 control-label is-required" >敏感词</label>
        <div class="col-sm-8">
           <input  type="text" id="keyword" class="form-control " placeholder="请输入敏感词" name="keyword"  required />
        </div>
    </div>
    <div class="form-group">
       <label  class="col-sm-3 control-label is-required" >分类</label>
        <div class="col-sm-8">
            <select class="form-control " name="keyword_type"  data-toggle="select" id="keyword_type" data-url="<?php echo url('keywordType/getAll'); ?>" data-field="type_name" required></select>
        </div>
    </div>
    <div class="form-group">
...
<div class="radio-box">
    <input type="radio" id="is_refuse_<?php echo htmlentities((string) $dict['dict_value']); ?>" name="is_refuse" value="<?php echo htmlentities((string) $dict['dict_value']); ?>" <?php echo $dict['is_default']==1 ? "checked"  :  ""; ?>>
