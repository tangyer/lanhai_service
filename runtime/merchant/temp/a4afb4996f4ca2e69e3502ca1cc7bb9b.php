    ...
    <form class="form-horizontal m" id="hr-form" data-ref="activeCode">
        ...
        <div class="form-group">
           <label  class="col-sm-3 control-label is-required" >所属分组</label>
            <div class="col-sm-8">
               <select class="form-control select2" name="active_code_group_id" data-url="<?php echo url('activeCodeGroup/all'); ?>" data-toggle="select" data-field="group_name" ></select>
            </div>
        </div>
        <div class="form-group">
           <label  class="col-sm-3 control-label is-required" >分配端口</label>
            <div class="col-sm-8">
               <input  type="text" id="port_num" class="form-control " data-num="<?php echo htmlentities((string) $port_num); ?>" placeholder="请输入分配端口,不得超过 <?php echo htmlentities((string) $port_num); ?>" name="port_num"  required />
            </div>
        </div>
        <div class="form-group">
