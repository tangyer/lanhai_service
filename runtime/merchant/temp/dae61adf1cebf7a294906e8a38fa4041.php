<?php /*a:3:{s:72:"D:\dev\www\LanHaiService\app\merchant\view\work_order_branch\update.html";i:1735138464;s:61:"D:\dev\www\LanHaiService\app\merchant\view\layout\layout.html";i:1735117447;s:57:"D:\dev\www\LanHaiService\app\merchant\view\public\js.html";i:1735013566;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
  <meta charset="utf-8">
    ...
    <form class="form-horizontal m" id="hr-form" data-ref="workOrderBranch">
        ...
        <div class="form-group">
           <label  class="col-sm-3 control-label is-required" >工单编号</label>
            <div class="col-sm-8">
               <input  type="text" id="order_code" class="form-control " placeholder="请输入工单编号" name="order_code" value="<?php echo htmlentities((string) $model['order_code']); ?>" required />
            </div>
        </div>
        <div class="form-group">
           <label  class="col-sm-3 control-label is-required" >短链平台</label>
            <div class="col-sm-8">
               <?php $_result=get_dict('sys_link_type');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dict): $mod = ($i % 2 );++$i;?>
                <div class="radio-box">
                    <input type="radio" id="link_type_<?php echo htmlentities((string) $dict['dict_value']); ?>" name="link_type" value="<?php echo htmlentities((string) $dict['dict_value']); ?>" <?php echo $dict['dict_value']==$model['link_type'] ? "checked"  :  ""; ?>>
        ...
        <div class="form-group" id="short_link_input">
           <label  class="col-sm-3 control-label is-required" >短链接</label>
            <div class="col-sm-8">
               <input  type="text" id="short_link" class="form-control " placeholder="请输入短链接" name="short_link" value="<?php echo htmlentities((string) $model['short_link']); ?>" />
            </div>
        </div>
        <div class="form-group">
            ...
            $.ajax({
                ...
                success : function(result) {
                    if (result.code == web_status.SUCCESS) {
                        ...
                        location.href = ctx + "/workOrderBranch/detail?order_code=<?php echo htmlentities((string) $model['order_code']); ?>";
                    }else{
                        $.modal.alertError("系统错误");
                    }
                }
