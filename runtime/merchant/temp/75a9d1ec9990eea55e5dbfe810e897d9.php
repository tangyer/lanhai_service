<?php /*a:3:{s:71:"D:\dev\www\LanHaiService\app\merchant\view\work_order_share\create.html";i:1735130101;s:61:"D:\dev\www\LanHaiService\app\merchant\view\layout\layout.html";i:1735117447;s:57:"D:\dev\www\LanHaiService\app\merchant\view\public\js.html";i:1735013566;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
  <meta charset="utf-8">
    ...
    <form class="form-horizontal m" id="hr-form" data-ref="workOrderShare">
        <div class="form-group">
           <label  class="col-sm-3 control-label is-required" >工单编号</label>
            <div class="col-sm-8">
               <input  type="text" id="order_code" class="form-control " value="<?php echo htmlentities((string) $order_code); ?>" name="order_code"  readonly />
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
           <label  class="col-sm-3 control-label is-required" >到期时间</label>
            <div class="col-sm-8">
               <input  type="text" id="expire_time" class="form-control time-input" data-type="datetime" data-format="yyyy-MM-dd HH:mm" placeholder="请输入到期时间" name="expire_time"  required />
            </div>
        </div>
        <div class="form-group">
           <label  class="col-sm-3 control-label is-required" >分享密码</label>
            <div class="col-sm-8">
               <input  type="text" id="password" class="form-control " placeholder="请输入分享密码" value="<?php echo htmlentities((string) $password); ?>" name="password"  required />
            </div>
        </div>
        <div class="form-group">
            ...
            $.ajax({
                ...
                success : function(result) {
                    if (result.code == web_status.SUCCESS) {
                        ...
                        location.href = ctx + "/workOrderShare/index?order_code=<?php echo htmlentities((string) $order_code); ?>";
                    }else{
                        $.modal.alertError("系统错误");
                    }
                }
