        ...
        <input  type="hidden" name="id" value="<?php echo htmlentities((string) $model['id']); ?>"/>
            ...
            <div class="form-group">
               <label  class="col-sm-3 control-label is-required" >激活码</label>
                <div class="col-sm-8">
                   <input  type="text" id="active_code" class="form-control " placeholder="请输入激活码" name="active_code" value="<?php echo htmlentities((string) $model['active_code']); ?>" readonly required />
                </div>
            </div>
            <div class="form-group">
                <label  class="col-sm-3 control-label is-required" >工单类型</label>
                <div class="col-sm-8">
                    <input  type="text" id="platform" class="form-control " placeholder="请输入工单类型" name="platform" value="<?php echo htmlentities((string) $model['platform']); ?>" readonly required />
                </div>
            </div>
            <div class="form-group">
               <label  class="col-sm-3 control-label is-required" >工单名称</label>
                <div class="col-sm-8">
                   <input  type="text" id="order_name" class="form-control " placeholder="请输入工单名称" name="order_name" value="<?php echo htmlentities((string) $model['order_name']); ?>" required />
                </div>
            </div>
            ...
            <div class="form-group">
               <label  class="col-sm-3 control-label is-required" >端口数</label>
                <div class="col-sm-8">
                   <input  type="text" id="port_num" class="form-control " placeholder="请输入端口数" name="port_num" value="<?php echo htmlentities((string) $model['port_num']); ?>"  required />
                </div>
            </div>
