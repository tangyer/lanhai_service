<?php /*a:4:{s:72:"D:\dev\www\LanHaiService\app\merchant\view\active_code_group\update.html";i:1735029645;s:61:"D:\dev\www\LanHaiService\app\merchant\view\layout\layout.html";i:1734774767;s:59:"D:\dev\www\LanHaiService\app\merchant\view\public\form.html";i:1735096945;s:57:"D:\dev\www\LanHaiService\app\merchant\view\public\js.html";i:1735013566;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
  <meta charset="utf-8">
    ...
    <form class="form-horizontal m" id="hr-form" data-ref="activeCodeGroup">
        ...
        <div class="form-group">
           <label  class="col-sm-3 control-label is-required" >备注</label>
            <div class="col-sm-8">
               <input  type="text" id="remark" class="form-control " placeholder="请输入备注" name="remark" value="<?php echo htmlentities((string) $model['remark']); ?>" required />
            </div>
        </div>
        <div class="form-group">
